...
RSYNC="sudo rsync -r -a -v -e 'sudo ssh -i $KEY' $X_USR@$X_INSTANCE"
CMD2="$RSYNC:$UPLOADS $UPLOADS"
CMD3="$RSYNC:$PLUGINS $PLUGINS"
CMD4="$RSYNC:$THEMES $THEMES"
CMD5="$RSYNC:$WFLOGS $WFLOGS"
